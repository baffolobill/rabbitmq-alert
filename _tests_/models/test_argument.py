...
from rabbitmqalert import argumentsparser, models, rabbitmqalert
...
class ArgumentTestCase(unittest.TestCase):
    ...
    def test_load_file_loads_global_file_when_exists_and_no_config_file_argument_given(self):
        ...
        logger.info.assert_called_once_with(f"Using configuration file \"{models.argument.CONFIG_FILE_PATH}\"")
    ...
    def test_get_type_returns_bool_type(self):
        ...
        self.assertEqual(bool, argument.get_type(argument_element))
    ...
    def test_get_type_returns_int_type(self):
        ...
        self.assertEqual(int, argument.get_type(argument_element))
    ...
    def test_get_type_returns_str_type(self):
        ...
        self.assertEqual(str, argument.get_type(argument_element))
    ...
    def test_create_argument_object_returns_object(self):
        ...
        self.assertEqual(argument_object.dest, 'foo')
        self.assertEqual(argument_object.type, int)
        self.assertEqual(argument_object.const, None)
    ...
    def test_get_value_returns_none_when_group_not_found_in_config_file(self):
        ...
        self.assertEqual(None, value)
        self.assertEqual(2, argument.get_value_from_file.call_count)
