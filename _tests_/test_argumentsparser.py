...
from rabbitmqalert import argumentsparser, rabbitmqalert
...
class ArgumentsParserTestCase(unittest.TestCase):
    ...
    def test_parse_returns_merged_arguments_and_conditions(self):
        ...
        self.assertEqual(arguments_dict, result)
    ...
    def test_format_conditions_returns_generic_and_queue_conditions(self):
        ...
        # generic conditions
        self.assertEqual(arguments_dict['conditions_consumers_connected'], results['generic_conditions']['conditions_consumers_connected'])
        self.assertEqual(arguments_dict['conditions_open_connections'], results['generic_conditions']['conditions_open_connections'])
        self.assertEqual(arguments_dict['conditions_nodes_running'], results['generic_conditions']['conditions_nodes_running'])
        self.assertEqual(arguments_dict['conditions_node_memory_used'], results['generic_conditions']['conditions_node_memory_used'])
        # queue conditions
        self.assertEqual(arguments_dict['conditions_ready_queue_size'], results['conditions']['foo-queue']['conditions_ready_queue_size'])
        self.assertEqual(arguments_dict['conditions_unack_queue_size'], results['conditions']['foo-queue']['conditions_unack_queue_size'])
        self.assertEqual(arguments_dict['conditions_total_queue_size'], results['conditions']['foo-queue']['conditions_total_queue_size'])
        self.assertEqual(arguments_dict['conditions_queue_consumers_connected'], results['conditions']['foo-queue']['conditions_queue_consumers_connected'])
    ...
    def test_format_conditions_returns_queue_conditions_when_exist(self):
        ...
        self.assertEqual(arguments_dict['conditions_unack_queue_size'], results['conditions']['bar-queue']['conditions_unack_queue_size'])
        self.assertEqual(arguments_dict['conditions_total_queue_size'], results['conditions']['bar-queue']['conditions_total_queue_size'])
        self.assertEqual(arguments_dict['conditions_queue_consumers_connected'], results['conditions']['bar-queue']['conditions_queue_consumers_connected'])
