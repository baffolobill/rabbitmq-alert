...
class ApiClientTestCase(unittest.TestCase):
    ...
    def test_get_queue_returns_result_when_no_error(self):
        ...
        uri = '/api/queues/{}/{}'.format(arguments['server_vhost'], arguments['server_queue'])
        client.send_request.assert_called_once_with(uri)
        self.assertEqual(self.construct_response_queue(), response)
    ...
    def test_get_queues_returns_queues_when_exist(self):
        ...
        self.assertEqual(['foo', 'bar'], queues)
    ...
    def test_get_connections_returns_result_when_no_error(self):
        ...
        client.send_request.assert_called_once()
        self.assertEqual(self.construct_response_connections(), response)
    ...
    def test_get_consumers_returns_result_when_no_error(self):
        ...
        client.send_request.assert_called_once()
        self.assertEqual(self.construct_response_consumers(), response)
    ...
    def test_send_request_returns_result_when_no_error(self):
        ...
        uri = '/api/nodes'
        url = '{}://{}:{}{}'.format(arguments['server_scheme'], arguments['server_host'], arguments['server_port'], uri)
